...
public class CompraController {
	...
	@GetMapping("/getComprasByClienteId/{cliente_id}")
	@CrossOrigin
	public ResponseEntity<ListaResposta> getComprasByClienteId(@PathVariable String cliente_id) {
		...
		listaResposta = compraService.getComprasByClienteId(cliente_id);
